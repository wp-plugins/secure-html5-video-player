...
<code>[video preload="yes"]</code>

<h4>autoplay</h4>
Start playing the video as soon as it's ready.<br /><br />
<code>[video autoplay="yes"]</code>

<h4>loop</h4>
Replay the video from the beginning after it completes playing.<br /><br />
<code>[video loop="yes"]</code>
...
<code>[video mp4="http://video-js.zencoder.com/oceans-clip.mp4" ogg="http://video-js.zencoder.com/oceans-clip.ogg" webm="http://video-js.zencoder.com/oceans-clip.webm" poster="http://video-js.zencoder.com/oceans-clip.png" preload="yes" autoplay="no" loop="no" width="640" height="264"]</code>
<br />
...
<code>[video file="video_clip" preload="yes" autoplay="yes" loop="yes" width="1600" height="900"]</code>
...
<h3>Server</h3>
	...
	<input type='text' id="secure_html5_video_player_key_seed" name='secure_html5_video_player_key_seed'  size='80' value='<?php print $secure_html5_video_player_key_seed ?>' maxlength="80" />
...
<h3>Playback</h3>
	...
	<input type='text' id="secure_html5_video_player_default_width" name='secure_html5_video_player_default_width'  size='10' value='<?php print $secure_html5_video_player_default_width ?>' /><br />
	...
	<input type='text' id="secure_html5_video_player_default_height" name='secure_html5_video_player_default_height' size='10' value='<?php print $secure_html5_video_player_default_height ?>' /><br />
	...
	<input type='checkbox' value="yes" id="secure_html5_video_player_default_preload" name='secure_html5_video_player_default_preload' <?php print $secure_html5_video_player_default_preload ?> /><br />
	...
	<input type='checkbox' value="yes" id="secure_html5_video_player_default_autoplay" name='secure_html5_video_player_default_autoplay' <?php print $secure_html5_video_player_default_autoplay ?> /><br />
	...
	<input type='checkbox' value="yes" id="secure_html5_video_player_default_loop" name='secure_html5_video_player_default_loop' <?php print $secure_html5_video_player_default_loop ?> /><br />
	<small><?php _e("If checked, the video will play again after it finishes.  Can be overrided by setting the <b>loop</b> attribute in the short tag to <b>yes</b> or <b>no</b>.", 'secure-html5-video-player'); ?></small>
	<br /><br />
...
<h3>Compatibility</h3>
	...
	<input type='checkbox' value="yes" id="secure_html5_video_player_enable_flash_fallback" name='secure_html5_video_player_enable_flash_fallback' <?php print $secure_html5_video_player_enable_flash_fallback ?> /><br />
	...
	<input type='checkbox' value="yes" id="secure_html5_video_player_enable_download_fallback" name='secure_html5_video_player_enable_download_fallback' <?php print $secure_html5_video_player_enable_download_fallback ?> /><br />
...
function secure_html5_video_player_shortcode_video($atts) {
  ...
  if ($loop == 'yes' || $loop == 'true') {
	...
	$object_tag_id = 'vjs-ff-' . secure_html5_video_player_filename_no_ext($mp4);
